...
suite("topn_project_pullup_column_pruning") {
    ...
    assertTrue(pullupPlanString.contains("PhysicalLazyMaterialize"))
    assertTrue(pullupPlanString.contains("operativeSlots=[id#"))
    assertFalse((pullupPlanString =~ /operativeSlots=\[id#\d+, struct_col#/).find())
